...
mixin _$FavoriteMovie {
 ...
 String get movieId; String get title; String? get posterPath; DateTime get likedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FavoriteMovie&&(identical(other.movieId, movieId) || other.movieId == movieId)&&(identical(other.title, title) || other.title == title)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.likedAt, likedAt) || other.likedAt == likedAt));
}


@override
int get hashCode => Object.hash(runtimeType,movieId,title,posterPath,likedAt);

@override
String toString() {
  return 'FavoriteMovie(movieId: $movieId, title: $title, posterPath: $posterPath, likedAt: $likedAt)';
}
...
@useResult
$Res call({
 String movieId, String title, String? posterPath, DateTime likedAt
});
...
/// Create a copy of FavoriteMovie
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? movieId = null,Object? title = null,Object? posterPath = freezed,Object? likedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String movieId,  String title,  String? posterPath,  DateTime likedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FavoriteMovie() when $default != null:
return $default(_that.movieId,_that.title,_that.posterPath,_that.likedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String movieId,  String title,  String? posterPath,  DateTime likedAt)  $default,) {final _that = this;
switch (_that) {
case _FavoriteMovie():
return $default(_that.movieId,_that.title,_that.posterPath,_that.likedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String movieId,  String title,  String? posterPath,  DateTime likedAt)?  $default,) {final _that = this;
switch (_that) {
case _FavoriteMovie() when $default != null:
return $default(_that.movieId,_that.title,_that.posterPath,_that.likedAt);case _:
  return null;
...
class _FavoriteMovie extends FavoriteMovie {
  const _FavoriteMovie({required this.movieId, required this.title, this.posterPath, required this.likedAt}): super._();
...
/// Create a copy of FavoriteMovie
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? movieId = null,Object? title = null,Object? posterPath = freezed,Object? likedAt = null,}) {
